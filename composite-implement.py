...
# In EnhancedDNAImageCipher class:
    ...
    def decrypt(self, image_path: str, output_path: str = "decrypted.png", rounds: int = 1):
...
def main():
    ...
    # 5. Additional Avalanche Visualization
    if PERFORM_AVALANCHE_TEST:
        ...
        print("\nAvalanche difference visualization saved")
